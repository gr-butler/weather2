...
// repeated edges within RainDebounceRepeatMs (500 ms) are ignored.
//
...
public:
    ...
    // nullptr if no tip LED is fitted.
    bool begin(uint8_t pin, Led *led);
...
private:
    ...
    volatile unsigned long lastTipMs_ = 0;    // debounce timestamp
    volatile bool tipFlashPending_ = false;
